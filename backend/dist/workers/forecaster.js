...
exports.startForecasterWorker = void 0;
...
const startForecasterWorker = () => {
    ...
    const runForecast = async () => {
        ...
        for (const domain of domains) {
            ...
            await (0, predictiveEngine_1.generateRiskForecast)(domain, recentEvents);
        }
...
exports.startForecasterWorker = startForecasterWorker;
